package com.sacristan.api.OLDinterfaces.admin.services.model.routine;
                    ...
                    if (incomingRs.getId() != null) {
                        ...
                        boolean isDuplicate = managedRoutine.getSequences().stream().anyMatch(existingRs ->
                                existingRs.getSequence().getId().equals(incomingRs.getSequence().getId()) &&
                                        Objects.equals(existingRs.getStartTime(), incomingRs.getStartTime()) &&
                                        Objects.equals(existingRs.getEndTime(), incomingRs.getEndTime())
                        );
